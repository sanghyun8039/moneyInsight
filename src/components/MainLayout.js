...
const MainLayout = ({ticker}) =>
{
    ...
    console.log(diffOneMonth.toISOString().split('T')[0]);
    console.log(diffThreeMonth.toISOString().split('T')[0]);
    console.log(diffSixMonth.toISOString().split('T')[0]);
    console.log(diffOneYear.toISOString().split('T')[0]);
    return (
        <div>
        </div>
      );
